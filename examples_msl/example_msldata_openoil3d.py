...
# MODEL SELECTION
###############################
o = OpenOil3D(loglevel=0, weathering_model = 'default') #weathering_model = 'noaa' or 'default' # Set loglevel to 0 for debug information
...
o.seed_elements(lon, lat, 
                ...
                z=0.0,
                oiltype='MARIN DIESEL', # must be picked from availabale o.oil_types
                # m3_per_hour =***) # 
