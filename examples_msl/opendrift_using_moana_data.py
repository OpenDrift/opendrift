...
# PHYSICS
###############################
o.fallback_values['x_wind'] = 0.0
o.fallback_values['y_wind'] = 0.0
o.fallback_values['x_sea_water_velocity'] = 0.0
o.fallback_values['y_sea_water_velocity'] = 0.0
o.fallback_values['sea_floor_depth_below_sea_level'] = 100000.0

# horizontal and vertical diffusion
Kxy = 1.0 #0.1176 # m2/s-1
Kz = 0.001 # m2/s-1
o.fallback_values['ocean_vertical_diffusivity'] = Kz # specify constant ocean_vertical_diffusivity in m2.s-1
o.set_config('vertical_mixing:diffusivitymodel', 'constant') # constant >> use fall back values o.fallback_values['ocean_vertical_diffusivity'] = Kz for all profile
